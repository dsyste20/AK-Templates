...
export default function PublicerenPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    alert('Publiceren functie wordt binnenkort toegevoegd!');
    // Hier kun je later de logica toevoegen om websites te publiceren
  };
        ...
        <div style={styles.section}>
          ...
          <form onSubmit={handleSubmit} style={styles.form}>
            ...
            <div style={styles.inputGroup}>
              ...
              <small style={styles.hint}>
                Deze wordt gebruikt als onderdeel van je website URL
              </small>
            </div>
          ...
          <div style={styles.info}>
            ...
            <ul style={styles.list}>
              ...
              <li style={styles.listItem}>
                De URL kan later nog aangepast worden
              </li>
              <li style={styles.listItem}>
